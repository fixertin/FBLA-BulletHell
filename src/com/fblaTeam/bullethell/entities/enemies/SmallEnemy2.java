...
public class SmallEnemy2 extends Enemy{
	public int index = 0;
	public Animation explosionAnimation;
	public ArcObserver ao = new ArcObserver();
	
	public SmallEnemy2(Handler handler, double x, double y) {
		super(handler, x, y);
		explosionAnimation = new Animation(1, Assets.explosion, 1);
		health = 2;
	}
	public SmallEnemy2(Handler handler, double x, double y, int speed) {
		super(handler, x, y);
		this.speed = speed;
	}
	...
	public void render(Graphics g) {
		if(!isDead)
			g.drawImage(Assets.smallShip2, (int)x, (int)y, null);
		else
